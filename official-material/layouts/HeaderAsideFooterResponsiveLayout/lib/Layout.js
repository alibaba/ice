...
var HeaderAsideFooterResponsiveLayout = (_temp = _class = function (_Component) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          Layout.Section,
          null,
          this.state.isScreen === 'isMobile' && React.createElement(
            'a',
          ...
          React.createElement(
            ...
            this.state.isScreen === 'isMobile' && React.createElement(Logo, null),
            React.createElement(
              Menu,
              {
...
}(Component), _class.propTypes = {}, _class.defaultProps = {}, _initialiseProps = function _initialiseProps() {
  var _this2 = this;
  ...
  this.enquireScreenRegister = function () {
    ...
    enquire.register(isMobile, _this2.enquireScreenHandle('isMobile'));
    enquire.register(isTablet, _this2.enquireScreenHandle('isTablet'));
    enquire.register(isDesktop, _this2.enquireScreenHandle('isDesktop'));
  };
  ...
  this.toggleCollapse = function () {
    var collapse = _this2.state.collapse;

    var openKeys = !collapse ? [] : _this2.openKeysCache;
  ...
  this.toggleMenu = function () {
    var openDrawer = _this2.state.openDrawer;
  ...
  this.getOpenKeys = function () {
    var routes = _this2.props.routes;
