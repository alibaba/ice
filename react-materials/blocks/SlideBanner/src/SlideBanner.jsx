  ...
  render() {
    ...
    return (
      <div className="hy-friends-list">
        <a
          href="https://openhome.alipay.com/caseCenter/caseCenterDetail.htm?id=Property001"
          target="_blank"
          ...
          <h4>南都物业</h4>
          <span>适用场景：物业缴费</span>
          <p>南都物业公司在接入支付宝在线物业缴费渠道之后，线上线下推广支付宝在线缴费上线一个月后，缴费日均超过200笔，大幅提升了缴费效率</p>
          <img className="hy-friends-qr" src="https://gw.alipayobjects.com/zos/rmsportal/MhShJeukuJNkenGytSiq.svg"/>
        </a>

        <a
          href="https://openhome.alipay.com/caseCenter/caseCenterDetail.htm?id=121"
          target="_blank"
          ...
          <p>金地物业借助生活号打造智慧社区，整合蚂蚁金服的资源，引入各项服务与资源，从而增加收入，同时积累大批关注用户，实现了良性循环</p>
          <img className="hy-friends-qr" src="https://gw.alipayobjects.com/zos/rmsportal/cONkAwDeKdlzkcgchJLT.png"/>
        </a>

        <a
          href="https://openhome.alipay.com/caseCenter/caseCenterDetail.htm?id=122"
          target="_blank"
        ...
        <a
          href="https://openhome.alipay.com/caseCenter/caseCenterDetail.htm?id=123"
          target="_blank"
          ...
          <p>接入支付宝的物业缴费和余利宝等功能，物业费自动转入余利宝，上线2个月，余利宝的日均余额超过200万元，按照7日年化4%的收益，年度收益达到8万元</p>
          <img className="hy-friends-qr" src="https://gw.alipayobjects.com/zos/rmsportal/cONkAwDeKdlzkcgchJLT.png"/>
        </a>
      </div>
    );
