export default {
  ...
  'iceworks.setting.general.custom.registry': 'npm - Customize registry',
  ...
  'iceworks.project.panel.router.form.path.tip': 'Fill in the path to begin with /',
  ...
  'iceworks.project.panel.router.form.redirect.tip': 'If a redirect path is filled in, the access path will be redirected to this path.',
  ...
  'iceworks.material.officialMaterial': 'Recommended material',
