...
var _reactMonacoEditor = require('react-monaco-editor');
...
var MonacoEditor = (_temp = _class = function (_Component) {
  ...
  _createClass(MonacoEditor, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                vsBasePath = '//unpkg.com/monaco-editor@0.10.1/min/vs';
                _context.next = 3;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'monaco-editor-container', style: styles.monacoEditorContainer },
        _react2.default.createElement(
          _card2.default,
          { style: styles.container },
          monacoReady ? _react2.default.createElement(_reactMonacoEditor2.default, {
            height: '600',
            language: 'javascript',
            theme: 'vs-dark',
            value: code,
  ...
  return MonacoEditor;
}(_react.Component), _class.displayName = 'MonacoEditor', _class.propTypes = {}, _class.defaultProps = {}, _temp);
