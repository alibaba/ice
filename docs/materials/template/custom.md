...
- [《组件模版规范》](/docs/material/template/component.md)
- [《区块模版规范》](/docs/material/template/block.md)
- [《项目模版规范》](/docs/material/template/scaffold.md)

当物料模版创建成功后，还需要关注基于该模版开发的物料在发布时是否满足物料数据协议标准：

- 关于物料数据生成及发布可参考[《物料数据生成》](/docs/material/guide/generate.md)、[《物料托管与使用》](/docs/material/guide/usage.md)
- 关于物料数据协议标准可参考[《物料数据协议》](/docs/material/reference/protocol.md)
